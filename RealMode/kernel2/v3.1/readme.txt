...
This version uses a calling convention similar to v3.0, however the arguments in the stack are cleared by the callee function rather than the caller function.
